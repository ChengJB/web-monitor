import { EVENTTYPES, BREADCRUMBTYPES } from '@chengjb/common';
import { validateOption, getTimestamp, _support } from '@chengjb/utils';
import { BreadcrumbData, InitOptions } from '@chengjb/types';
