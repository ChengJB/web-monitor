...
import { SdkBase, RecordScreenOption, BasePlugin } from '@chengjb/types';
import { EVENTTYPES } from '@chengjb/common';
import { validateOption, generateUUID, _support } from '@chengjb/utils';
